    ...
    <div>
      ...
      <nav className="navbar navbar-expand-lg bg-dark">
        <div className="container-fluid new-side">
          ...
          <button className="navbar-toggler btn-bu" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
